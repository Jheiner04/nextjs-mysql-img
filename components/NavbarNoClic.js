...
const Navbar = ({ validate }) => {
  ...
  useEffect(() => {
    const drawers = Array.prototype.slice.call(document.querySelectorAll('[data-drawer-target]'));
    drawers.forEach((drawer) => {
      const target = document.getElementById(drawer.getAttribute('data-drawer-target'));
      if (!target) return;
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center justify-start">
              ...
              <a href="https://flowbite.com" className="flex ml-2 md:mr-24">
                <Image src="/img/pagina_01.png" className="h-8 mr-3" alt="Descripción de la imagen" width={140} height={40} />
              </a>
            </div>
            <div className="flex items-center">
              <p className="text-sm text-gray-900 dark:text-white mr-2" role="none">
                {validate.username}
              </p>
              <button onClick={() => logout()}>
                <a className="flex items-center p-1 text-gray-900 rounded-lg dark:text-white hover:bg-red-100 dark:hover:bg-red-700">
